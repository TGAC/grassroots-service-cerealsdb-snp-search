 ...
 * @brief
 */
#ifndef CEREALSDB_SNP_SERVICE_LIBRARY_H
#define CEREALSDB_SNP_SERVICE_LIBRARY_H
...
*/
  ...
  #ifdef CEREALSDB_SNP_SERVICE_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define CEREALSDB_SNP_SERVICE_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define CEREALSDB_SNP_SERVICE_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef CEREALSDB_SNP_LIBRARY_EXPORTS */
  #define CEREALSDB_SNP_SERVICE_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define CEREALSDB_SNP_SERVICE_API
  #define CEREALSDB_SNP_SERVICE_LOCAL
	...
	#define CEREALSDB_SNP_SERVICE_CONCAT_VAL(x,y)
#endif
...
#endif		/* #ifndef CEREALSDB_SNP_SERVICE_LIBRARY_H */
